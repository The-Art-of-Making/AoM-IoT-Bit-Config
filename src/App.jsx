    ...
    <div className="container pb-5">
      ...
      <Table title="Wifi" hide={true} body={
        <>
          <Input
            label="Wifi SSID"
            description="(Case-sensitive!) Name of the Wifi network the bit will connect to. If you are using a phone as a mobile hotspot, it will be the name of your phone."
            currentInput={SECRET_SSID}
            setInput={set_SECRET_SSID}
          />
          <Input
            label="Wifi Password"
            description="(Case-sensitive!) Password of the Wifi network the bit will connect to. Keep the SSID and password a secret!"
